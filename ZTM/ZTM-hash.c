...
#define mZTM_HASHTEXT(HASH) \
	ZT_DATA lData;\
	if (iHash != NULL && (lData.ptr = (void*)iText) != NULL) {\
		if ((lData.length = ZTC8_GetLength(iText))) {HASH(iHash, &lData);}\
	}
void ZTM_HashText_128(ZT_HASH128* iHash, const ZT_CHAR* iText) {mZTM_HASHTEXT(ZTM_HashData_128);}
void ZTM_HashText_MD5(ZT_HASH128* iHash, const ZT_CHAR* iText) {mZTM_HASHTEXT(ZTM_HashData_MD5);}
void ZTM_HashText_DJB2(ZT_HASH32* iHash, const ZT_CHAR* iText) {mZTM_HASHTEXT(ZTM_HashData_DJB2);}
void ZTM_HashText_DJB2A(ZT_HASH32* iHash, const ZT_CHAR* iText) {mZTM_HASHTEXT(ZTM_HashData_DJB2A);}
void ZTM_HashText_SDBM_32(ZT_HASH32* iHash, const ZT_CHAR* iText) {mZTM_HASHTEXT(ZTM_HashData_SDBM_32);}
void ZTM_HashText_SDBM_64(ZT_HASH64* iHash, const ZT_CHAR* iText) {mZTM_HASHTEXT(ZTM_HashData_SDBM_64);}
void ZTM_HashText_FNV0_32(ZT_HASH32* iHash, const ZT_CHAR* iText) {mZTM_HASHTEXT(ZTM_HashData_FNV0_32);}
void ZTM_HashText_FNV0_64(ZT_HASH64* iHash, const ZT_CHAR* iText) {mZTM_HASHTEXT(ZTM_HashData_FNV0_64);}
void ZTM_HashText_FNV1_32(ZT_HASH32* iHash, const ZT_CHAR* iText) {mZTM_HASHTEXT(ZTM_HashData_FNV1_32);}
void ZTM_HashText_FNV1_64(ZT_HASH64* iHash, const ZT_CHAR* iText) {mZTM_HASHTEXT(ZTM_HashData_FNV1_64);}
void ZTM_HashText_FNV1A_32(ZT_HASH32* iHash, const ZT_CHAR* iText) {mZTM_HASHTEXT(ZTM_HashData_FNV1A_32);}
void ZTM_HashText_FNV1A_64(ZT_HASH64* iHash, const ZT_CHAR* iText) {mZTM_HASHTEXT(ZTM_HashData_FNV1A_64);}
#undef mZTM_HASHTEXT
#define mZTM_HASHTEXTNEW(TYPE,NEW,HASH) \
	ZT_DATA lData;\
	...
	return NULL
ZT_HASH128* ZTM_HashTextNew_128(const ZT_CHAR* iText) {mZTM_HASHTEXTNEW(ZT_HASH128, ZTM_HashNew_128, ZTM_HashData_128);}
ZT_HASH128* ZTM_HashTextNew_MD5(const ZT_CHAR* iText) {mZTM_HASHTEXTNEW(ZT_HASH128, ZTM_HashNew_128, ZTM_HashData_MD5);}
ZT_HASH32* ZTM_HashTextNew_DJB2(const ZT_CHAR* iText) {mZTM_HASHTEXTNEW(ZT_HASH32, ZTM_HashNew_32, ZTM_HashData_DJB2);}
ZT_HASH32* ZTM_HashTextNew_DJB2A(const ZT_CHAR* iText) {mZTM_HASHTEXTNEW(ZT_HASH32, ZTM_HashNew_32, ZTM_HashData_DJB2A);}
ZT_HASH32* ZTM_HashTextNew_SDBM_32(const ZT_CHAR* iText) {mZTM_HASHTEXTNEW(ZT_HASH32, ZTM_HashNew_32, ZTM_HashData_SDBM_32);}
ZT_HASH64* ZTM_HashTextNew_SDBM_64(const ZT_CHAR* iText) {mZTM_HASHTEXTNEW(ZT_HASH64, ZTM_HashNew_64, ZTM_HashData_SDBM_64);}
ZT_HASH32* ZTM_HashTextNew_FNV0_32(const ZT_CHAR* iText) {mZTM_HASHTEXTNEW(ZT_HASH32, ZTM_HashNew_32, ZTM_HashData_FNV0_32);}
ZT_HASH64* ZTM_HashTextNew_FNV0_64(const ZT_CHAR* iText) {mZTM_HASHTEXTNEW(ZT_HASH64, ZTM_HashNew_64, ZTM_HashData_FNV0_64);}
ZT_HASH32* ZTM_HashTextNew_FNV1_32(const ZT_CHAR* iText) {mZTM_HASHTEXTNEW(ZT_HASH32, ZTM_HashNew_32, ZTM_HashData_FNV1_32);}
ZT_HASH64* ZTM_HashTextNew_FNV1_64(const ZT_CHAR* iText) {mZTM_HASHTEXTNEW(ZT_HASH64, ZTM_HashNew_64, ZTM_HashData_FNV1_64);}
ZT_HASH32* ZTM_HashTextNew_FNV1A_32(const ZT_CHAR* iText) {mZTM_HASHTEXTNEW(ZT_HASH32, ZTM_HashNew_32, ZTM_HashData_FNV1A_32);}
ZT_HASH64* ZTM_HashTextNew_FNV1A_64(const ZT_CHAR* iText) {mZTM_HASHTEXTNEW(ZT_HASH64, ZTM_HashNew_64, ZTM_HashData_FNV1A_64);}
#undef mZTM_HASHTEXTNEW
