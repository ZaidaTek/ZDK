...
#define ZTX11_X11_EVENT_MASK (SubstructureRedirectMask | SubstructureNotifyMask | StructureNotifyMask | ExposureMask)
#define ZTX11_X11_INPUT_MASK (ExposureMask | KeyPressMask | KeyReleaseMask | ButtonPressMask | ButtonReleaseMask | FocusChangeMask)
