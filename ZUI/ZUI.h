...
extern "C" {
#endif // __cplusplus
///FIX ME, implemented in ZUI_DataValue, -Maximum, -Minimum & -Unit
void ZUI_WorkaroundForSwitchUpdating(ZUI_ELEMENT* iElement); // TEMPORARY workaround to hide/show ZUI element to reflect changes to data/etc...
